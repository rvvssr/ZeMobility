...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UINavigationController *frontNavigationController  = [[UINavigationController alloc]initWithRootViewController:menuVC];
    
    navController.navigationBar.backgroundColor=[UIColor blackColor];
    //navController.navigationItem.title =@"Schlumberger";
    SWRevealViewController *revealController = [[SWRevealViewController alloc] initWithRearViewController:frontNavigationController frontViewController:navController];
