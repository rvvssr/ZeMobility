...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [label.text sizeWithAttributes:
                        @{NSFontAttributeName:
    ...
    //CGRect detailsLabelSize = [detailsLabel.text boundingRectWithSize:CGSizeMake(maxWidth, remainingHeight)
   // options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSParagraphStyleAttributeName: paragraphStyle.copy}
                                        // context:nil];
//    CGRect detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize
//                                         options:NSStringDrawingUsesLineFragmentOrigin
//                                      attributes:@{NSFontAttributeName:detailsLabel.font}
//                                         context:nil];
//    
//    CGSize size = detailsLabelSize.size;
